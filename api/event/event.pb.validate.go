...
func (m *UpdateEventRequest) validate(all bool) error {
	...
	if m.GetStatus() != "" {
		...
		if _, ok := _UpdateEventRequest_Status_InLookup[m.GetStatus()]; !ok {
			err := UpdateEventRequestValidationError{
				field:  "Status",
				reason: "value must be in list [draft published archived]",
			}
	...
	if m.GetVisibility() != "" {
		...
		if _, ok := _UpdateEventRequest_Visibility_InLookup[m.GetVisibility()]; !ok {
			err := UpdateEventRequestValidationError{
				field:  "Visibility",
				reason: "value must be in list [public private]",
			}
...
var _UpdateEventRequest_Status_InLookup = map[string]struct{}{
	"draft":     {},
	"published": {},
	"archived":  {},
}

var _UpdateEventRequest_Visibility_InLookup = map[string]struct{}{
	"public":  {},
	"private": {},
}
